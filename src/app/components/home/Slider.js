                    ...
                    <Col>
                        <div className="centered-div-vertical">
                            <h1 className='title' style={{fontSize: '55px'}}>
                                Estudios audiologicos,<br/>a donde vayas.
                            </h1>
                            <p style={{fontSize: '18px'}}>
                                Todo en un solo lugar, sin importar de cuando sea o donde te lo hayas hecho.<br/>                                Tenelo al alcance de tu mano, siempre.
                            </p>
