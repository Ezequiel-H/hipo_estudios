        ...
        >
          ...
          <Col sm={2} lg={2}>
            ...
            <div className='mt-4'>
                ...
                <p className='mb-0'>Apellido: <strong>Gomez</strong></p>
                <p className='mb-0'>Nombre: <strong>Jorge</strong></p>
                <p className='mb-0'>Fecha de nacimiento: <strong>25/02/1976</strong></p>
            </div>
            <div className='mt-4'>
